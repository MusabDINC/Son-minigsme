...
import { Rocket } from '/javascript/World/Rocket.js'
...
export default class World
{
    constructor(_options)
    {
        ...
        // Loader ve items nesnelerini tanımla
        this.loader = this.resources.loader
    ...
    tiles: this.tiles,
    debug: this.debugFolder,
    x: -38, // Haritanıza göre bu konumu değiştirin
    y: -34, // Haritanıza göre bu konumu değiştirin
    sounds: this.sounds
})
this.container.add(this.sections.playground.container)
    ...
    setRocket() 
    {
        ...
        this.rocket = new Rocket({
            ...
            debug: this.debug,
            sounds: this.sounds,
            position: new THREE.Vector3(-8, -32, 5) // Z koordinatını daha yüksek bir değere ayarlıyoruz (2'den 5'e çıkarıldı)
        })
        ...
        this.rocketLaunchArea = this.areas.add({
            position: new THREE.Vector2(-8, -32),
    ...
    setFootball()
{
    ...
    // Futbol oyununu başlat (lazy-loading yaklaşımı)
    const footballArea = this.areas.add({
        position: new THREE.Vector2(-25, -30), // Futbol alanının pozisyonu - haritanıza göre ayarlayın
        halfExtents: new THREE.Vector2(5, 5),
        debug: false,
        hasKey: false
    })
    
    footballArea.on('interact', () => {
        // Futbol mini oyununu başlat
